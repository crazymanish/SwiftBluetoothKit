Pod::Spec.new do |s|
  s.name = "SwiftBluetoothKit"
  s.version = '0.0.1'
  s.summary = "SwiftBluetoothKit is a Bluetooth framework written in Swift."
  s.platform = :ios, "10.0"
  ...
  s.source_files = ["Source/SwiftBluetoothKit/SwiftBluetoothKit/**/*.{h,swift}"]
  s.requires_arc = true
